...
namespace Turnero.DataSets {
    ...
    public partial class TurnosDS : global::System.Data.DataSet {
        ...
        public partial class TurnosDataTable : global::System.Data.TypedTableBase<TurnosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public TurnosRow AddTurnosRow(System.DateTime fecha, System.TimeSpan hora, int medico, int idEspecialidad, string paciente, int idPractica, int obraSocial) {
...
namespace Turnero.DataSets.TurnosDSTableAdapters {
    ...
    public partial class TurnosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Turnos] WHERE (([fecha] = @Original_fecha) AND ([hora] = @Original_hora) AND ([medico] = @Original_medico) AND ([idEspecialidad] = @Original_idEspecialidad) AND ([paciente] = @Original_paciente) AND ([idPractica] = @Original_idPractica) AND ([obraSocial] = @Original_obraSocial))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Turnos] ([fecha], [hora], [medico], [idEspecialidad], [paciente], [idPractica], [obraSocial]) VALUES (@fecha, @hora, @medico, @idEspecialidad, @paciente, @idPractica, @obraSocial);
SELECT fecha, hora, medico, idEspecialidad, paciente, idPractica, obraSocial FROM Turnos WHERE (fecha = @fecha) AND (hora = @hora) AND (medico = @medico)";
...
SELECT fecha, hora, medico, idEspecialidad, paciente, idPractica, obraSocial FROM Turnos WHERE (fecha = @fecha) AND (hora = @hora) AND (medico = @medico)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT fecha, hora, medico, idEspecialidad, paciente, idPractica, obraSocial FROM" +
                " dbo.Turnos";
        ...
        public virtual int Fill(TurnosDS.TurnosDataTable dataTable) {
        ...
        public virtual TurnosDS.TurnosDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            TurnosDS.TurnosDataTable dataTable = new TurnosDS.TurnosDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(TurnosDS.TurnosDataTable dataTable) {
        ...
        public virtual int Delete(System.DateTime Original_fecha, System.TimeSpan Original_hora, int Original_medico, int Original_idEspecialidad, string Original_paciente, int Original_idPractica, int Original_obraSocial) {
        ...
        public virtual int Insert(System.DateTime fecha, System.TimeSpan hora, int medico, int idEspecialidad, string paciente, int idPractica, int obraSocial) {
        ...
        public virtual int Update(System.DateTime fecha, System.TimeSpan hora, int medico, int idEspecialidad, string paciente, int idPractica, int obraSocial, System.DateTime Original_fecha, System.TimeSpan Original_hora, int Original_medico, int Original_idEspecialidad, string Original_paciente, int Original_idPractica, int Original_obraSocial) {
            ...
            this.Adapter.UpdateCommand.Parameters[9].Value = ((int)(Original_medico));
            this.Adapter.UpdateCommand.Parameters[10].Value = ((int)(Original_idEspecialidad));
            if ((Original_paciente == null)) {
                throw new global::System.ArgumentNullException("Original_paciente");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[12].Value = ((int)(Original_idPractica));
            this.Adapter.UpdateCommand.Parameters[13].Value = ((int)(Original_obraSocial));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int idEspecialidad, string paciente, int idPractica, int obraSocial, System.DateTime Original_fecha, System.TimeSpan Original_hora, int Original_medico, int Original_idEspecialidad, string Original_paciente, int Original_idPractica, int Original_obraSocial) {
            return this.Update(Original_fecha, Original_hora, Original_medico, idEspecialidad, paciente, idPractica, obraSocial, Original_fecha, Original_hora, Original_medico, Original_idEspecialidad, Original_paciente, Original_idPractica, Original_obraSocial);
        }
    }
